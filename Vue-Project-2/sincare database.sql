...
CREATE TABLE IF NOT EXISTS skin_care_info (
    ...
    recommended_products LONGTEXT COMMENT '추천 제품 이름 / 설명',
    key_ingredients LONGTEXT COMMENT '제품 핵심 성분 (예: 히알루론산, 세라마이드 등)',
    purchase_link LONGTEXT COMMENT '최저가 / 구매 링크',
